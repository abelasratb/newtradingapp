...
import { TradingSimulator } from './TradingSimulator.tsx';
import { PatternTrainer } from './PatternTrainer.tsx';
import { FundamentalTrainer } from './FundamentalTrainer.tsx';
import { PriceActionGame } from './PriceActionGame.tsx';
import { EconomicCalendar } from './EconomicCalendar.tsx';
import { MindsetHub } from './MindsetHub.tsx';
import { TradingJournal } from './TradingJournal.tsx';
import { AdminPanel } from './AdminPanel.tsx';
import { Auth } from './Auth.tsx';
import { PaymentScreen } from './PaymentScreen.tsx';
import { AiMentor } from './AiMentor.tsx';
import { CommunityForum } from './CommunityForum.tsx';
...
const App = () => {
  ...
  const handleManualLogin = (user: User) => {
    setCurrentUser(user);
    // Explicitly persist login to avoid state loss on reload
